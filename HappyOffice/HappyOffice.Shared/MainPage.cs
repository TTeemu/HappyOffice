...
namespace HappyOffice
{
    ...
    {
        private MobileServiceCollection<Point, Point> items;
        private IMobileServiceTable<Point> todoTable = App.MobileService.GetTable<Point>();
        ...
        private async Task InsertTodoItem(Point todoItem)
        {
        ...
        private async Task UpdateCheckedTodoItem(Point item)
        {
        ...
        private async void CheckBoxComplete_Checked(object sender, RoutedEventArgs e)
        {
            ...
            Point item = cb.DataContext as Point;
